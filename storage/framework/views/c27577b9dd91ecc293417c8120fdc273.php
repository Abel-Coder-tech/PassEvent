...
<head>
    <meta charset="UTF-8">
    <title>Billet - <?php echo e($ticket->evenement?->titre ?? 'Evenement'); ?></title>
    <style>
        @page {
            margin: 0;
            padding: 0;
...
<table class="ticket" cellpadding="0" cellspacing="0">
    <tr><td class="inner">
        ...
        <div class="event-title"><?php echo e($ticket->evenement?->titre ?? 'Evenement'); ?></div>
        <div class="event-meta">
            <?php echo e($ticket->evenement?->date_event?->format('d M Y') ?? '---'); ?>

            &ndash; <?php echo e($ticket->evenement?->date_event?->format('H\hi') ?? ''); ?>

            <?php if($ticket->evenement?->lieu): ?>
                &ndash; <?php echo e($ticket->evenement->lieu); ?>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="text-align:left;vertical-align:top">
                        ...
                        <div class="participant-name"><?php echo e($ticket->nom_acheteur ?? '---'); ?></div>
                        <div class="participant-email"><?php echo e($ticket->email_acheteur ?? ''); ?></div>
                    </td>
        ...
        <table class="detail-grid" cellpadding="0" cellspacing="4">
            <tr>
                <td>
                    ...
                    <div class="dv"><?php echo e(ucfirst($ticket->categorie ?? '---')); ?></div>
                </td>
                <td>
                    <div class="dl">Type</div>
                    <div class="dv"><?php echo e($ticket->type === 'normal' ? 'Standard' : 'VIP'); ?></div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="dl">Montant</div>
                    <div class="dv"><?php echo e(number_format($ticket->montant, 0, ',', ' ')); ?> <small>FCFA</small></div>
                </td>
                <td>
                    <div class="dl">Paiement</div>
                    <div class="dv"><?php echo e(ucfirst($ticket->methode_paiement ?? '---')); ?></div>
                </td>
            </tr>
        </table>
        ...
        <table class="tx-table" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td class="tv-mono"><?php echo e($ticket->transaction_id ?? '---'); ?></td>
            </tr>
            <tr>
                <td class="tl">Paiement</td>
                <td class="tv"><?php echo e($ticket->methode_paiement ?? '---'); ?></td>
            </tr>
            <tr>
                <td class="tl">Date d'achat</td>
                <td class="tv"><?php echo e($ticket->date_achat?->format('d/m/Y \\· H:i') ?? '---'); ?></td>
            </tr>
            <tr>
                <td class="tl">Statut scan</td>
                <td>
                    <?php if($ticket->scanne): ?>
        ...
        <?php if($ticket->montant_reduction > 0): ?>
            <table class="tx-table" cellpadding="0" cellspacing="0" style="margin-top:4px">
                <tr>
                    ...
                    <td class="tv" style="color:#2E7D4F">&minus;<?php echo e(number_format($ticket->montant_reduction, 0, ',', ' ')); ?> FCFA</td>
                </tr>
            </table>
        <?php endif; ?>
        ...
        <div class="qr-block">
            ...
            <div class="qr-code-display"><?php echo e($ticket->code_unique); ?></div>
        </div>
...
<?php /**PATH C:\Users\DELL\Documents\Laravel\passEvent\resources\views/tickets/pdf/ticket.blade.php ENDPATH**/ ?>