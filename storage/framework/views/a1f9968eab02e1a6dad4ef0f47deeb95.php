...
<body>
    <div class="card">
        <div class="card-body">
            ...
            <a href="<?php echo e(url('/')); ?>" class="btn btn-primary"><i class="bi bi-house me-1"></i> Réessayer</a>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\DELL\Documents\Laravel\passEvent\resources\views\errors\503.blade.php ENDPATH**/ ?>