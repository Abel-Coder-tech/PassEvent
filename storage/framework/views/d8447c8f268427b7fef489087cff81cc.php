...
<?php $__env->startSection('topbar-actions'); ?>
    ...
    <a href="<?php echo e(route('scan.clear')); ?>" class="btn btn-secondary-custom btn-sm ms-2">
    ...
    <div class="scan-container">
        ...
        <div class="d-flex align-items-center justify-content-between mb-3 p-3" style="background: linear-gradient(135deg, rgba(123,63,160,0.06), rgba(46,125,79,0.06)); border-radius: 14px;">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <div class="fw-bold" style="font-size: 1rem;"><?php echo e($accessEvenement->titre); ?></div>
                </div>
            </div>
            <a href="<?php echo e(route('scan.clear')); ?>" class="btn btn-sm btn-outline-secondary" style="border-radius: 8px; font-size: 0.78rem;">
        ...
        <div class="row g-3 mb-4">
            <div class="col-6 col-md-3">
                <div class="metric-card" style="border-top-color: var(--sombre);">
                    ...
                    <div class="metric-value" style="font-size: 1.5rem;"><?php echo e($stats['total_scans']); ?></div>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="metric-card" style="border-top-color: var(--vert);">
                    ...
                    <div class="metric-value" style="font-size: 1.5rem;"><?php echo e($stats['scans_today']); ?></div>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="metric-card" style="border-top-color: var(--teal);">
                    ...
                    <div class="metric-value" style="font-size: 1.5rem;"><?php echo e($stats['scans_valides']); ?></div>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="metric-card" style="border-top-color: var(--danger);">
                    ...
                    <div class="metric-value" style="font-size: 1.5rem;"><?php echo e($stats['scans_invalides']); ?></div>
                </div>
            </div>
        </div>
                    ...
                    <div class="panel-card-body">
                        <div class="d-flex align-items-center gap-2 mb-3 p-2" style="background: rgba(123,63,160,0.06); border-radius: 10px;">
                            ...
                            <div class="min-w-0">
                                ...
                                <div class="fw-semibold" style="font-size: 0.88rem;"><?php echo e($accessEvenement->titre); ?></div>
                            </div>
                        </div>
        ...
        <div class="panel-card">
            <div class="panel-card-header">
                ...
                <span class="text-muted" style="font-size: 0.78rem;"><?php echo e($scans->count()); ?> derniers scans</span>
            </div>
            <div class="panel-card-body">
                        ...
                        <div class="scan-history-item">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center gap-2 min-w-0">
                                    <i class="bi <?php echo e($icon); ?>" style="color: <?php echo e($colorClass); ?>; font-size: 1.1rem;"></i>
                                    <div class="min-w-0">
                                        <div class="fw-semibold" style="font-size: 0.82rem;">
                                            <?php echo e($scan->ticket ? Str::limit($scan->ticket->nom_acheteur, 25) : 'Inconnu'); ?>

                                        </div>
                                        <div class="text-muted" style="font-size: 0.72rem;">
                                            <?php echo e($scan->ticket && $scan->ticket->evenement ? Str::limit($scan->ticket->evenement->titre, 30) : ''); ?>

                                            <?php echo e($details['raison'] ?? '' ? ' · ' . str_replace('_', ' ', $details['raison'] ?? '') : ''); ?>

                                        </div>
                                    </div>
                                </div>
                                <div class="text-end flex-shrink-0">
                                    <div style="font-size: 0.78rem;"><?php echo e($scan->created_at->format('H:i')); ?></div>
                                    <div class="text-muted" style="font-size: 0.68rem;"><?php echo e($scan->created_at->format('d/m/Y')); ?></div>
                                </div>
                            </div>
                        </div>
...
function verifyCode(code) {
    ...
    fetch('<?php echo e(route('scan.verifier')); ?>', {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\Documents\Laravel\passEvent\resources\views\admin\scan\index.blade.php ENDPATH**/ ?>