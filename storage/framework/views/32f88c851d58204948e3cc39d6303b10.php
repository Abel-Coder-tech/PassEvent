<?php $__env->startSection('title', 'Logs système - PassEvent'); ?>

<?php $__env->startSection('page-title', 'Logs système'); ?>
...
<div class="page-content">
    ...
    <div class="panel-card mb-4">
        <div class="panel-card-body py-3">
            <form action="<?php echo e(route('logs.index')); ?>" method="GET" class="row g-2 align-items-end">
                <div class="col-12 col-md-4">
                    <label class="form-label fw-semibold" style="font-size: 0.78rem;">Rechercher</label>
                    <input type="text" name="q" class="form-control form-control-sm" placeholder="Nom, email, code ticket, IP..." value="<?php echo e($q); ?>">
                </div>
                <div class="col-6 col-md-2">
                    ...
                    <select name="type" class="form-select form-select-sm">
                        ...
                        <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php echo e($type === $key ? 'selected' : ''); ?>><?php echo e($info['label']); ?></option>
                ...
                <div class="col-6 col-md-2">
                    ...
                    <select name="periode" class="form-select form-select-sm">
                        <option value="7" <?php echo e($periode === '7' ? 'selected' : ''); ?>>Aujourd'hui</option>
                        <option value="30" <?php echo e($periode === '30' ? 'selected' : ''); ?>>7 derniers jours</option>
                        <option value="90" <?php echo e($periode === '90' ? 'selected' : ''); ?>>30 derniers jours</option>
                ...
                <div class="col-12 col-md-2">
                    <a href="<?php echo e(route('logs.index')); ?>" class="btn btn-secondary-custom btn-sm w-100" style="border-radius: 6px;">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-6 col-lg">
            <div class="metric-card" style="border-top-color: var(--violet);">
                ...
                <div class="metric-value" style="font-size: 1.5rem;"><?php echo e(number_format($stats['achats'])); ?></div>
            </div>
        </div>
        <div class="col-6 col-lg">
            <div class="metric-card" style="border-top-color: var(--vert);">
                ...
                <div class="metric-value" style="font-size: 1.5rem;"><?php echo e(number_format($stats['envois'])); ?></div>
            </div>
        </div>
        <div class="col-6 col-lg">
            <div class="metric-card" style="border-top-color: var(--teal);">
                ...
                <div class="metric-value" style="font-size: 1.5rem;"><?php echo e(number_format($stats['scans'])); ?></div>
            </div>
        </div>
        <div class="col-6 col-lg">
            <div class="metric-card" style="border-top-color: var(--danger);">
                ...
                <div class="metric-value" style="font-size: 1.5rem;"><?php echo e(number_format($stats['echecs'])); ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="panel-card">
        <div class="panel-card-header">
            ...
            <span class="text-muted" style="font-size: 0.78rem;"><?php echo e($logs->total()); ?> opération<?php echo e($logs->total() > 1 ? 's' : ''); ?></span>
        </div>
        <div class="panel-card-body p-0">
            <?php if($logs->count() > 0): ?>
                    ...
                    <table class="table custom-table mb-0">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <div style="font-size: 0.82rem; white-space: nowrap;"><?php echo e($log->created_at->format('d/m/Y')); ?></div>
                                        <small class="text-muted"><?php echo e($log->created_at->format('H:i:s')); ?></small>
                                    </td>
                                    <td>
                                        <?php if($log->ticket): ?>
                                            <div class="fw-bold" style="font-size: 0.82rem;"><?php echo e(Str::limit($log->ticket->nom_acheteur, 25)); ?></div>
                                            <small class="text-muted" style="font-size: 0.72rem;"><?php echo e(Str::limit($log->ticket->email_acheteur, 30)); ?></small>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        <span class="status-badge" style="background: <?php echo e($typeInfo['color']); ?>15; color: <?php echo e($typeInfo['color']); ?>;"><?php echo e($typeInfo['label']); ?></span>
                                    </td>
                                    <td>
                                        <div style="font-size: 0.78rem; max-width: 200px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                            <?php if(is_array($log->details)): ?>
                                                <?php echo e($log->details['message'] ?? ($log->details['canal'] ?? json_encode($log->details))); ?>

                                            <?php else: ?>
                                                <?php echo e(Str::limit($log->details, 40)); ?>

                                            <?php endif; ?>
                                        </div>
                                    </td>
                                    <td>
                                        <?php if(is_array($log->details) && isset($log->details['canal'])): ?>
                                            <?php
                                            ...
                                            ?>
                                            <span style="font-size: 0.78rem;"><i class="<?php echo e($canalIcon); ?> me-1"></i><?php echo e(ucfirst($log->details['canal'])); ?></span>
                                        <?php else: ?>
                                            <span class="text-muted" style="font-size: 0.78rem;">web</span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <?php if(in_array($log->type_operation, ['achat', 'envoi', 'scan', 'recuperation'])): ?>
                                            <span class="badge" style="background: rgba(18,151,110,0.12); color: var(--vert); font-size: 0.68rem;">Succès</span>
                                        <?php elseif($log->type_operation === 'echec_paiement'): ?>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-sm btn-secondary-custom" style="border-radius: 6px; padding: 0.25rem 0.5rem;" onclick="showLogDetail(<?php echo e($log->id); ?>)" title="Détail">
                                            <i class="bi bi-eye"></i>
                                        </button>
                                    </td>
                                </tr>
                ...
                <div class="p-3">
                    <?php echo e($logs->appends(['type' => $type, 'q' => $q, 'periode' => $periode])->links()); ?>
...
document.getElementById('formRecuperer').addEventListener('submit', function(e) {
    ...
    fetch('<?php echo e(route("tickets.recuperer")); ?>', {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\Documents\Laravel\passEvent\resources\views\admin\logs\index.blade.php ENDPATH**/ ?>