...
<body>
    <div class="container">
        ...
        <div class="content">
            <p class="greeting">Bonjour <strong><?php echo e($ticket->nom_acheteur); ?></strong>,</p>
            ...
            <div class="event-card">
                <div class="event-header">
                    ...
                    <h2><?php echo e($ticket->evenement->titre); ?></h2>
                </div>
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <td>&#128197; Date et heure</td>
                        <td><?php echo e($ticket->evenement->date_event->format('d/m/Y \a H:i')); ?></td>
                    </tr>
                    <tr>
                        <td>&#128205; Lieu</td>
                        <td><?php echo e($ticket->evenement->lieu); ?></td>
                    </tr>
                    <tr>
                        <td>&#127915; Billet</td>
                        <td><?php echo e(ucfirst($ticket->type === 'normal' ? 'Standard' : 'VIP')); ?> &middot; <?php echo e(ucfirst($ticket->categorie)); ?></td>
                    </tr>
                    <tr>
                        <td>&#128196; Code</td>
                        <td><span class="code-block"><?php echo e($ticket->code_unique); ?></span></td>
                    </tr>
                    <tr>
                        <td>&#128178; Montant pay&eacute;</td>
                        <td class="price"><?php echo e(number_format($ticket->montant, 0, ',', ' ')); ?> FCFA</td>
                    </tr>
                </table>
            </div>
            ...
            <div class="btn-wrap">
                <a href="<?php echo e(route('tickets.telecharger', $ticket->id)); ?>" class="btn">T&eacute;l&eacute;charger mon billet</a>
            </div>

            <p class="help-text">
                En cas de probl&egrave;me, contactez <a href="mailto:passevent2026@gmail.com">passevent2026@gmail.com</a><br>
                <span class="ref">R&eacute;f&eacute;rence : <?php echo e($ticket->transaction_id); ?></span>
            </p>
        </div>

        <div class="footer">
            <p>PassEvent &mdash; Billetterie intelligente pour vos &eacute;v&eacute;nements au B&eacute;nin</p>
            <p style="margin-top: 4px;"><a href="<?php echo e(url('/aide')); ?>">Centre d'aide</a></p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\DELL\Documents\Laravel\passEvent\resources\views/emails/ticket.blade.php ENDPATH**/ ?>