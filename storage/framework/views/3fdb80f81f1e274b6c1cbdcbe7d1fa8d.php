...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Super Admin - PassEvent'); ?></title>
...
<div class="sa-wrapper">
    <aside class="sa-sidebar" id="saSidebar">
        ...
        <nav class="sa-sidebar-nav">
            ...
            <a href="<?php echo e(route('superadmin.statistiques')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.statistiques') ? 'active' : ''); ?>">
                <i class="bi bi-bar-chart-fill"></i> Statistiques
            </a>
            <a href="<?php echo e(route('superadmin.securite')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.securite') ? 'active' : ''); ?>">
                <i class="bi bi-shield-fill"></i> Securite
            </a>

            <div class="sa-nav-section">Gestion</div>
            <a href="<?php echo e(route('superadmin.utilisateurs')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.utilisateurs') ? 'active' : ''); ?>">
                <i class="bi bi-people-fill"></i> Utilisateurs
            </a>
            <a href="<?php echo e(route('superadmin.organisateurs')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.organisateurs') ? 'active' : ''); ?>">
                <i class="bi bi-person-badge-fill"></i> Organisateurs
            </a>
            <a href="<?php echo e(route('superadmin.evenements')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.evenements') ? 'active' : ''); ?>">
                <i class="bi bi-calendar-event-fill"></i> Evenements
            </a>
            <a href="<?php echo e(route('superadmin.moderation')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.moderation') ? 'active' : ''); ?>">
                <i class="bi bi-shield-exclamation"></i> Moderation
            </a>

            <div class="sa-nav-section">Finances</div>
            <a href="<?php echo e(route('superadmin.transactions')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.transactions') ? 'active' : ''); ?>">
                <i class="bi bi-cash-stack"></i> Transactions
            </a>
            <a href="<?php echo e(route('superadmin.tickets')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.tickets') ? 'active' : ''); ?>">
                <i class="bi bi-ticket-perforated-fill"></i> Tickets
            </a>
            <a href="<?php echo e(route('superadmin.scans')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.scans') ? 'active' : ''); ?>">
                <i class="bi bi-qr-code"></i> Scans
            </a>

            <div class="sa-nav-section">Systeme</div>
            <a href="<?php echo e(route('superadmin.notifications')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.notifications') ? 'active' : ''); ?>">
                <i class="bi bi-bell-fill"></i> Notifications
            </a>
            <a href="<?php echo e(route('superadmin.logs')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.logs') ? 'active' : ''); ?>">
                <i class="bi bi-journal-text"></i> Logs systeme
            </a>
            <a href="<?php echo e(route('superadmin.parametres')); ?>" class="sa-nav-link <?php echo e(request()->routeIs('superadmin.parametres') ? 'active' : ''); ?>">
        ...
        <div class="sa-sidebar-footer">
            ...
            <form id="sa-logout-form" action="<?php echo e(route('superadmin.logout')); ?>" method="POST" style="display:none;"><?php echo csrf_field(); ?></form>
        </div>
    </aside>
    ...
    <main class="sa-main">
        <div class="sa-topbar">
            <div class="sa-topbar-left">
                ...
                <span class="sa-topbar-title"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></span>
            </div>
            <div class="sa-topbar-right">
                <span class="sa-topbar-badge"><i class="bi bi-shield-fill-check"></i> Super Admin</span>
                <span class="sa-topbar-date"><?php echo e(now()->format('d M Y')); ?></span>
            </div>
        </div>
...
<?php /**PATH C:\Users\DELL\Documents\Laravel\passEvent\resources\views\superadmin\layouts\master.blade.php ENDPATH**/ ?>