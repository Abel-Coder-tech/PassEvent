...
<?php if(auth()->guard()->check()): ?>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('superadmin.dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('superadmin.*') ? 'active' : ''); ?>">
        ...
        <div class="sidebar-user">
            ...
            <div class="sidebar-user-info">
                ...
                <div class="sidebar-user-role"><?php echo e(auth()->user()->role === 'super_admin' ? 'Super Admin' : 'Organisateur'); ?></div>
            </div>
        </div>
    </div>
<?php endif; ?>
