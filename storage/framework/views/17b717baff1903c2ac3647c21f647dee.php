...
<section class="event-banner position-relative">
    <?php if($evenement->image): ?>
        <div class="banner-img" style="background: url('<?php echo e(asset('storage/' . $evenement->image)); ?>') center/cover no-repeat;"></div>
        ...
        <div class="container">
            <div class="row g-4 align-items-end">
                <div class="col-12">
                    ...
                    <?php endif; ?>
                    <h1 class="display-6 fw-bold text-white mb-2 banner-title"><?php echo e($evenement->titre); ?></h1>
                    <div class="d-flex flex-wrap gap-3 text-white" style="font-size: 0.92rem; opacity: 0.9;">
                        <span><i class="bi bi-calendar3 me-1"></i><?php echo e($evenement->date_event->format('d M Y')); ?></span>
                        <span><i class="bi bi-clock me-1"></i><?php echo e($evenement->date_event->format('H:i')); ?></span>
                        <span><i class="bi bi-geo-alt me-1"></i><?php echo e($evenement->lieu); ?></span>
                        <span><i class="bi bi-people me-1"></i><?php echo e(number_format($placesRestantes, 0, ',', ' ')); ?> places</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="event-detail-card mb-4">
                    <div class="card-section">
                        ...
                        <?php if($evenement->description): ?>
                            <p class="text-muted" style="line-height: 1.75;"><?php echo e($evenement->description); ?></p>
                        <?php else: ?>
                ...
                <div class="event-detail-card mb-4">
                    <div class="card-section">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-sm-4">
                                <div class="p-3 rounded-3" style="background: var(--blanc-casse);">
                                    ...
                                    <div class="fw-bold mt-2"><?php echo e($evenement->date_event->format('d M Y')); ?></div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="p-3 rounded-3" style="background: var(--blanc-casse);">
                                    <i class="bi bi-clock" style="color: var(--vert);"></i>
                                    <div class="fw-bold mt-2"><?php echo e($evenement->date_event->format('H:i')); ?></div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="p-3 rounded-3" style="background: var(--blanc-casse);">
                                    <i class="bi bi-people" style="color: var(--teal);"></i>
                                    <div class="fw-bold mt-2"><?php echo e(number_format($evenement->capacite, 0, ',', ' ')); ?> places</div>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex align-items-center gap-2 mb-3 p-3 rounded-3" style="background: rgba(135,66,139,0.04);">
                            ...
                            <div>
                                <div class="fw-bold"><?php echo e($evenement->lieu); ?></div>
                            </div>
                        </div>
                        <!-- Google Maps Embed -->
                ...
                <div class="sidebar-sticky">
                    ...
                    <div class="event-detail-card mb-4">
                        ...
                        <div class="card-section">
                                        ...
                                        <?php $__currentLoopData = $tarifs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tarif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="tarif-card d-block" onclick="selectTarif(this)">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <span class="badge me-2" style="background: <?php echo e($tarif->categorie === 'etudiant' ? 'rgba(135,66,139,0.12)' : 'rgba(66,140,121,0.12)'); ?>; color: <?php echo e($tarif->categorie === 'etudiant' ? 'var(--violet)' : 'var(--teal)'); ?>;">
                                                            <?php echo e($tarif->categorie === 'etudiant' ? 'Etudiant' : 'Externe'); ?>

                                                        </span>
                                                        <strong><?php echo e($tarif->type === 'normal' ? 'Standard' : 'VIP'); ?></strong>
                                                    </div>
                                                    <strong style="color: var(--vert);"><?php echo e(number_format($tarif->prix, 0, ',', ' ')); ?> F</strong>
                                                </div>
                                            </label>
                            ...
                            <!-- Formulaire -->
                            <form action="<?php echo e(route('evenements.achat', $evenement->id)); ?>" method="POST" id="achatForm">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nom_acheteur" name="nom_acheteur" value="<?php echo e(old('nom_acheteur')); ?>" placeholder="Ex: Kofi Mensah" required>
                                </div>

                                <div class="mb-3">
                                    <label for="email_acheteur" class="form-label fw-semibold">Email <span class="text-danger">*</span></label>
                                    <input type="email" class="form-control" id="email_acheteur" name="email_acheteur" value="<?php echo e(old('email_acheteur')); ?>" placeholder="votre@email.com" required>
                                </div>

                                <div class="mb-3">
                                    <label for="telephone_acheteur" class="form-label fw-semibold">Telephone <span class="text-danger">*</span></label>
                                    <input type="tel" class="form-control" id="telephone_acheteur" name="telephone_acheteur" value="<?php echo e(old('telephone_acheteur')); ?>" placeholder="+229 43 70 45 13" required>
                                </div>

                                <div class="mb-3">
                                    <label for="code_promo" class="form-label fw-semibold">Code promo <span class="text-muted fw-normal">(optionnel)</span></label>
                                    <input type="text" class="form-control" id="code_promo" name="code_promo" value="<?php echo e(old('code_promo')); ?>" placeholder="PROMO-XXXXXX" style="text-transform: uppercase;">
                                </div>
                                ...
                                <button type="submit" class="btn btn-vert w-100 py-3" id="btnPayer" style="border-radius: 8px; font-size: 1rem;" <?php echo e($tarifs->isEmpty() || $estComplet ? 'disabled' : ''); ?>>
                    ...
                    <div class="event-detail-card mb-4">
                        <div class="card-section">
                            ...
                            <div class="d-flex gap-2">
                                <a href="https://wa.me/?text=<?php echo e(urlencode($evenement->titre . ' - ' . route('evenements.public.show', $evenement->id))); ?>" target="_blank" class="share-btn" title="WhatsApp" style="color: #25D366;">
                                    <i class="bi bi-whatsapp"></i>
                                </a>
                                <a href="https://twitter.com/intent/tweet?text=<?php echo e(urlencode($evenement->titre)); ?>&url=<?php echo e(urlencode(route('evenements.public.show', $evenement->id))); ?>" target="_blank" class="share-btn" title="Twitter" style="color: #1DA1F2;">
                                    <i class="bi bi-twitter-x"></i>
                                </a>
                                <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(route('evenements.public.show', $evenement->id))); ?>" target="_blank" class="share-btn" title="Facebook" style="color: #1877F2;">
                                        ...
                                        <a href="<?php echo e(route('evenements.public.show', $autre->id)); ?>" class="text-decoration-none">
                                            <div class="d-flex gap-3 align-items-center p-2 rounded-3" style="background: var(--blanc-casse); transition: background 0.15s;">
                                                ...
                                                <div class="flex-grow-1" style="min-width: 0;">
                                                    <div class="fw-bold" style="font-size: 0.82rem; color: var(--sombre); white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><?php echo e($autre->titre); ?></div>
