<?php $__env->startSection('title', 'Modifier le tarif'); ?>

<?php $__env->startSection('page-title', 'Modifier le tarif'); ?>
...
<div class="page-content">
    <div class="panel-card" style="max-width: 600px;">
        <div class="panel-card-body p-3 p-md-4">
            <form action="<?php echo e(route('admin.tarifs.update', [$evenement->id, $tarif->id])); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="categorie" name="categorie" required>
                            <option value="etudiant" <?php echo e(old('categorie', $tarif->categorie) == 'etudiant' ? 'selected' : ''); ?>>Étudiant</option>
                            <option value="externe" <?php echo e(old('categorie', $tarif->categorie) == 'externe' ? 'selected' : ''); ?>>Externe</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>" id="type" name="type" required>
                            <option value="normal" <?php echo e(old('type', $tarif->type) == 'normal' ? 'selected' : ''); ?>>Normal</option>
                            <option value="vip" <?php echo e(old('type', $tarif->type) == 'vip' ? 'selected' : ''); ?>>VIP</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>" id="prix" name="prix" value="<?php echo e(old('prix', $tarif->prix)); ?>" step="0.01" min="0" required>
...
unset($__errorArgs, $__bag); ?>" id="quantite_disponible" name="quantite_disponible" value="<?php echo e(old('quantite_disponible', $tarif->quantite_disponible)); ?>" min="1">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\Documents\Laravel\passEvent\resources\views\tarifs\edit.blade.php ENDPATH**/ ?>