    ...
    <header class="public-header">
        <div class="container header-inner position-relative">
            ...
            <ul class="public-nav" id="publicNav">
                ...
                <li><a href="<?php echo e(route('tickets.recuperer')); ?>" class="nav-recuperer <?php echo e(request()->routeIs('tickets.recuperer', 'tickets.rechercher') ? 'active' : ''); ?>">Mon ticket</a></li>
            </ul>
        </div>
    </header>
        ...
        <div class="container">
            ...
            <div class="footer-bottom text-center">
                <p class="mb-0" style="color: rgba(255,255,255,0.5); font-size: 0.82rem;">
                    &copy; <?php echo e(date('Y')); ?> PassEvent · Billetterie intelligente · Benin
                </p>
                <div class="mt-2">
                    <a href="<?php echo e(route('confidentialite')); ?>" class="text-decoration-none" style="color: rgba(255,255,255,0.5); font-size: 0.75rem;">Politique de confidentialite</a>
                    <span class="mx-1" style="color: rgba(255,255,255,0.3);">·</span>
                    <a href="<?php echo e(route('cgu')); ?>" class="text-decoration-none" style="color: rgba(255,255,255,0.5); font-size: 0.75rem;">CGU</a>
                </div>
            </div>
        </div>
    </footer>
