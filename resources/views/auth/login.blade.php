...
@section('title', 'Connexion — PassEvent')
            ...
            <form method="POST" action="{{ route('login.post') }}">
                ...
                <div class="mb-3">
                    <div class="position-relative">
                        ...
                        <input type="email" class="form-control ps-5 py-3 border rounded-3 @error('email') is-invalid @enderror" id="email" name="email" placeholder="Email" value="{{ old('email') }}" required autofocus style="border-color: #e2e0e4;">
                    </div>
                    @error('email')
                ...
                <div class="mb-4">
                    <div class="position-relative">
                        ...
                        <input type="password" class="form-control ps-5 pe-5 py-3 border rounded-3 @error('mot_de_passe') is-invalid @enderror" id="mot_de_passe" name="mot_de_passe" placeholder="Mot de passe" required style="border-color: #e2e0e4;">
