...
@section('steps')
    @include('auth.register.steps', ['current' => 2])
@endsection

@section('page-title', 'Étape 2 — Organisation')
...
@section('card-content')
    ...
    <form method="POST" action="{{ route('inscriptions.post-org') }}" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <div class="doc-info mb-2"><i class="bi bi-file-earmark-text"></i> <span id="doc-text">Carte étudiante ou lettre de l'université</span></div>
