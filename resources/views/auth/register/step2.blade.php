...
<style>
    ...
    .card-register h1 { font-size: 1.5rem; font-weight: 700; color: #1d1d1f; text-align: center; }
    .card-register .subtitle { font-size: .9rem; color: #6c757d; margin-bottom: 1.5rem; text-align: center; }
    .card-register .form-control, .card-register .form-select { border-radius: 10px; padding: .65rem 1rem; border: 1.5px solid #e0dde3; }
    .card-register .form-control:focus, .card-register .form-select:focus { border-color: #542680; box-shadow: 0 0 0 3px rgba(84,38,128,.12); }
    ...
    .type-card {
        border: 2px solid #e0dde3; border-radius: 14px; padding: 1.25rem; cursor: pointer;
