...
<p style="text-align:center;">Vous recevrez un email de confirmation à&nbsp;<span class="text-center" style="font-weight:700;color:#542680;word-break:break-all;display:block;">{{ $email }}</span> sous 2h maximum.</p>
