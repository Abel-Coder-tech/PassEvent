...
<style>
    ...
    .card-register h1 { font-size: 1.5rem; font-weight: 700; color: #1d1d1f; margin-bottom: 1.5rem; text-align: center; }
    ...
    .card-register .btn-primary:disabled { opacity: .5; cursor: not-allowed; transform: none; }
