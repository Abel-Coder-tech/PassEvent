...
<head>
    ...
    var tarteaucitronCustomText = {
        "alertBigPrivacy": "PaxEvent utilise des cookies pour mesurer l'audience et améliorer votre expérience. Vous gardez le contrôle : choisissez ceux que vous souhaitez activer.",
        "acceptAll": "Tout accepter",
        "personalize": "Personnaliser",
        "privacyUrl": "Lire la politique de confidentialité",
        ...
        "mandatoryText": "Ces cookies sont indispensables au fonctionnement du site (connexion, sécurité, paiement). Ils ne peuvent pas être désactivés.",
        "analytic": {
            "title": "Mesure d'audience",
            "details": "Ces services mesurent la fréquentation de PaxEvent (pages vues, provenance des visites) afin d'améliorer nos événements."
        },
        "ads": {
            "title": "Publicité",
            "details": "Ces services permettent de diffuser des contenus publicitaires susceptibles de vous intéresser."
        },
        "google": {
            "title": "Services Google",
            "details": "Google (Google Analytics, Google Tag Manager) peut utiliser vos données pour mesurer l'audience ou la performance de nos campagnes."
        },
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        html body #tarteaucitronRoot #tarteaucitronAlertBig {
            ...
            box-shadow: 0 20px 50px rgba(33,28,49,0.28);
            color: var(--sombre);
            max-width: 940px;
            margin: 0 auto 16px;
            font-size: 15px;
        ...
        #tarteaucitronAlertBig #tarteaucitronDisclaimerAlert { color: var(--sombre); }
        ...
        html body #tarteaucitronRoot #tarteaucitronAlertBig #tarteaucitronPersonalize2 {
            background: linear-gradient(135deg, var(--violet), #3d1a5c) !important;
            color: #fff !important;
            box-shadow: 0 4px 12px rgba(84,38,128,0.35);
        }
        html body #tarteaucitronRoot #tarteaucitronAlertBig #tarteaucitronPersonalize2:hover { filter: brightness(1.1); }
        ...
        html body #tarteaucitronRoot #tarteaucitron {
            border-radius: 14px;
            overflow: hidden;
            box-shadow: 0 30px 70px rgba(33,28,49,0.35);
            font-size: 14px;
        }
        ...
        html body #tarteaucitronRoot #tarteaucitron #tarteaucitronMainLineOffset {
            background: linear-gradient(135deg, var(--violet) 0%, #3d1a5c 100%);
            color: #fff;
            border-radius: 0;
        }
        ...
        #tarteaucitronMainLineOffset #tarteaucitronInfo { color: rgba(255,255,255,0.9) !important; }
        ...
        #tarteaucitronServices .tarteaucitronTitle .asCatToggleBtn,
        ...
        /* Lignes de services & boutons Autoriser/Interdire */
        #tarteaucitronServices .tarteaucitronLine .tarteaucitronName .tarteaucitronH3,
        .tarteaucitronName .tarteaucitronH3 { color: var(--sombre); }
        ...
        @media (max-width: 767.98px) {
            html body #tarteaucitronRoot #tarteaucitron { max-width: 96vw !important; }
            html body #tarteaucitronRoot #tarteaucitronAlertBig { margin: 0 8px 8px; }
        }
    </style>
    @yield('styles')
</head>
