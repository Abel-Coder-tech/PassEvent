    ...
    <header class="public-header">
        <div class="container header-inner position-relative">
            ...
            <ul class="public-nav" id="publicNav">
                ...
                <li><a href="{{ route('login') }}" class="btn btn-sm text-white ms-2" style="border: 2px solid var(--violet); color: var(--violet); border-radius: 6px; padding: 6px 16px;">Se connecter</a></li>
            </ul>
        </div>
    </header>
        ...
        <div class="container py-5">
            <div class="row g-4">
                ...
                <div class="col-6 col-md-3">
                    <h6>Support</h6>
                    <ul class="footer-links">
                        <li><a href="#"><i class="bi bi-chevron-right me-1" style="font-size:0.65rem;"></i>Conditions générales de vente</a></li>
