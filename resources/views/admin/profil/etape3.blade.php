    ...
    <div class="wizard-card">
        ...
        <div class="recap-card">
            ...
            @if($data['type'] === 'universitaire' || $data['type'] === 'organisation')
                ...
                @endif
                @if(!empty($data['nom_representant']))
                <div class="recap-row">
                    <span class="recap-label"><i class="bi bi-person" style="color:#9972B0;font-size:0.8rem;"></i> Nom du représentant</span>
                    <span class="recap-value">{{ $data['nom_representant'] }}</span>
                </div>
                @endif
            ...
            <div class="recap-row">
                <span class="recap-label"><i class="bi bi-key" style="color:#9972B0;font-size:0.8rem;"></i> N° RC / Récépissé</span>
                <span class="recap-value">{{ $data['numero_rc'] }}</span>
            </div>
            @endif
            <div class="recap-row">
