...
@section('title', 'Agents de vente')

@section('content')
<div class="container-fluid py-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="fw-bold mb-0"><i class="bi bi-people"></i> Agents de vente</h5>
        <a href="{{ route('admin.agents-vente.create') }}" class="btn btn-sm text-white" style="background: #7c3aed;">
    ...
    <div class="text-center py-5 text-muted">
        ...
        <p class="mt-2">Aucun agent de vente pour le moment.</p>
        <a href="{{ route('admin.agents-vente.create') }}" class="btn btn-sm text-white" style="background: #7c3aed;">
            Créer un agent
        </a>
    </div>
            ...
            <table class="table table-hover align-middle mb-0 small">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ $agent->tickets_count }}</td>
                        <td class="text-end">{{ number_format($agent->montant_total, 0, ',', ' ') }} F</td>
                        ...
                        <td class="text-end pe-3">
                            <a href="{{ route('admin.agents-vente.show', $agent) }}"
                                class="btn btn-sm btn-outline-secondary py-0 px-2" title="Voir détails">
                                <i class="bi bi-eye"></i>
                            </a>
                            <form action="{{ route('admin.agents-vente.toggle-actif', $agent) }}"
                            ...
                            <form action="{{ route('admin.agents-vente.destroy', $agent) }}"
                                method="POST" class="d-inline"
