...
<div class="page-content">
    ...
    <div class="card border-0 shadow-sm mt-4 overflow-hidden">
        <div class="help-header d-flex align-items-center gap-2 px-3 py-3">
            <i class="bi bi-question-circle-fill fs-4" style="color:#6f42c1;"></i>
            <div>
                <div class="fw-semibold">Comment ça marche ?</div>
                <div class="small text-muted">Créez le design de votre ticket physique en quelques clicks.</div>
            </div>
            <span class="badge rounded-pill ms-auto" style="background:#6f42c1;color:#fff;">Aide</span>
        </div>
        <div class="card-body">
            <div class="accordion" id="helpAccordion">
                <div class="accordion-item border-0 rounded-3 shadow-sm mb-2 overflow-hidden">
                    <h2 class="accordion-header">
                        <button class="accordion-button fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSteps" aria-expanded="true" aria-controls="collapseSteps">
                ...
                <div class="accordion-item border-0 rounded-3 shadow-sm mb-2 overflow-hidden">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseDims" aria-expanded="false" aria-controls="collapseDims">
                ...
                <div class="accordion-item border-0 rounded-3 shadow-sm overflow-hidden">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMargins" aria-expanded="false" aria-controls="collapseMargins">
