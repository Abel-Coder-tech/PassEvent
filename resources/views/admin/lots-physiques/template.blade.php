...
<div class="page-content">
    ...
    .zoom-bar {
        ...
        padding: .45rem .6rem;
        background: #faf7fd;
        border: 1px solid rgba(84,38,128,.18);
        border-radius: 10px;
    }
    .zoom-bar-label { font-size: .75rem; font-weight: 700; color: #542680; white-space: nowrap; display: flex; align-items: center; gap: .3rem; }
    .zoom-step {
        width: 28px;
        height: 28px;
        flex: 0 0 28px;
        border: 1px solid rgba(84,38,128,.3);
        background: #fff;
        color: #542680;
        border-radius: 8px;
        display: flex;
    ...
    .zoom-step:hover { background: #542680; color: #fff; }
    .zoom-bar .form-range { flex: 1; min-width: 0; margin: 0; accent-color: #542680; }
    .zoom-badge {
        flex: 0 0 52px;
        text-align: center;
        font-size: .8rem;
    ...
    .help-accordion .accordion-item { border: 1px solid rgba(84,38,128,.15); }
    .help-accordion .accordion-button { color: #542680; background: #fff; box-shadow: none; font-weight: 600; font-size: .88rem; }
    ...
    <div class="card border-0 shadow-sm mt-4 overflow-hidden">
        <div class="d-flex align-items-center gap-2 px-3 py-3" style="background:#faf7fd;border-bottom:1px solid rgba(84,38,128,.12);">
            <i class="bi bi-question-circle-fill fs-4" style="color:#542680;"></i>
            <div>
                <div class="fw-semibold" style="color:#542680;">Comment ça marche ?</div>
                <div class="small text-muted">Créez le design de votre ticket physique en quelques clics.</div>
            </div>
            <span class="badge rounded-pill ms-auto" style="background:#542680;color:#fff;">Aide</span>
        </div>
        <div class="card-body">
            <div class="accordion help-accordion" id="helpAccordion">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSteps" aria-expanded="true" aria-controls="collapseSteps">
                            <i class="bi bi-list-ol me-2" style="color:#542680;"></i> Les 4 étapes
                        </button>
                    </h2>
                    <div id="collapseSteps" class="accordion-collapse collapse show" data-bs-parent="#helpAccordion">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseDims" aria-expanded="false" aria-controls="collapseDims">
                            <i class="bi bi-image me-2" style="color:#542680;"></i> Dimensions d'image acceptées
                        </button>
                    </h2>
                                    ...
                                    <tbody>
                                        @foreach(\App\Models\LotPhysique::FORMATS as $def)
                                            <tr>
                                                ...
                                                <td><span class="badge rounded-pill" style="background:rgba(84,38,128,.08);color:#542680;border:1px solid rgba(84,38,128,.2);">{{ str_replace('.', ',', rtrim(rtrim(number_format($def['largeur'] / $def['hauteur'], 2, ',', ''), '0'), ',')) }} : 1</span></td>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMargins" aria-expanded="false" aria-controls="collapseMargins">
                            <i class="bi bi-scissors me-2" style="color:#542680;"></i> Marges & découpe
                        </button>
                    </h2>
                    <div id="collapseMargins" class="accordion-collapse collapse" data-bs-parent="#helpAccordion">
                        <div class="accordion-body">
                            <div class="d-flex flex-column gap-2 mb-3">
                                <div class="d-flex align-items-center gap-2 p-2 rounded-3 help-line small">
                                    <i class="bi bi-square-half" style="color:#542680;"></i>
                                    <span><strong>Marge externe :</strong> 4 mm autour du bloc de tickets sur l'A4.</span>
                                </div>
                                <div class="d-flex align-items-center gap-2 p-2 rounded-3 help-line small">
                                    <i class="bi bi-border-style" style="color:#542680;"></i>
