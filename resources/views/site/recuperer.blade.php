...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">Recuperer mon ticket</li>
@endsection
                ...
                <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                    <div class="card-body p-4 text-center">
                        <div class="mb-4">
                            ...
                            <h4 class="fw-bold mb-2">Recuperer mon ticket</h4>
                            <p class="text-muted mb-0" style="font-size: 0.9rem;">
                                Entrez les informations utilisees lors de l'achat
                            </p>
                        </div>
                        ...
                        <form action="{{ route('tickets.rechercher') }}" method="POST">
                            ...
                            <div class="mb-3 text-start">
                                <label for="nom" class="form-label fw-semibold">Nom et prenoms</label>
                            ...
                            <div class="mb-4 text-start">
                                <label for="telephone" class="form-label fw-semibold">Numero de telephone</label>
